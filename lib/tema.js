...
/** Huruf judul: berkait seperti buku, atau polos seperti seluruh isi situs. */
const HURUF = {
  berkait: "var(--font-instrument), Georgia, Cambria, 'Times New Roman', serif",
  polos: 'var(--font-plus-jakarta), ui-sans-serif, system-ui, sans-serif',
};
...
export function gayaDariPanel(tampilan = {}) {
  ...
  */
  ...
  if (huruf) baris.push(`--tampil-huruf:${HURUF[huruf]}`);
